...
import 'package:permission_handler/permission_handler.dart' as a;
...
class Moyai extends StatefulWidget {
  ...
  const Moyai({Key? key}) : super(key: key);

  /// Utility method to create a page with the Baseflow templating.
  static ExamplePage createPage() {
    return ExamplePage(
        Icons.location_on, (context) => const Moyai());
  }

  @override
  State<Moyai> createState() => _MoyaiState();
}
...
class _MoyaiState extends State<Moyai> {
  ...
  Future<void> requestLocationPermission() async {
    final a.PermissionStatus status = await a.Permission.location.request();
    if (status.isGranted) {
      _handlePermission();
    } else {
